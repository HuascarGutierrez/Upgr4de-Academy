      ...
      <header>
        ...
        <div className="icons">
          <span id="prev" className="material-symbols-rounded" onClick={() => handlePrevNext("prev")}>
            <img src="https://www.bing.com/images/blob?bcid=Tu0rIE0gZzMIiwhn2BaEwWbCV1D8.....8o" alt="" />
          </span>
          <span id="next" className="material-symbols-rounded" onClick={() => handlePrevNext("next")}>
            <img src="https://www.bing.com/images/blob?bcid=ThHU9.cESTMIiwhn2BaEwWbCV1D8.....4A" alt="" />
          </span>
        </div>
      </header>
