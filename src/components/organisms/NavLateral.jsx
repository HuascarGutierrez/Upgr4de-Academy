    ...
    <div className="navLateral">
      ...
      <div className="navLateral_content">
        <ul className="navLateral_list">
          ...
          {/* Mantén el botón de "Salir" al final */}
          <li
            onClick={() => {
              navigate("/");
            }}
            className="navLateral_item navLateral_exit"
          >
            <svg
              width="40px"
              height="40px"
